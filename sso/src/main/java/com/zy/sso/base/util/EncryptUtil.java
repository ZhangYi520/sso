...
public class EncryptUtil {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String url = "http://www.baidu.com?backUrl=444654";
		
		String encodeUrl = encode(url);
		
		System.out.println("加密后的地址" + encodeUrl);
		
		String decodeUrl = new String(decode(encodeUrl));
		
		System.out.println("解密后的地址" + decodeUrl);
		
		/*System.out
				.println(new String(
						decode("OTIwNjAzODAwMDAwODAwOTkyMQ==")));*/
